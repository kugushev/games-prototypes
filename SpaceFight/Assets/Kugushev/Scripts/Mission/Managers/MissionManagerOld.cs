...
namespace Kugushev.Scripts.Mission.Managers
{
    ...
    public class MissionManagerOld : ScriptableObject
    {
            ...
            bool preparation)
        {
            ...
            var scene = preparation ? MissionPreparationScene : MissionExecutionScene;
        ...
        public async UniTask StartMission()
        {
            ...
            await SceneManager.LoadSceneAsync(MissionExecutionScene);
        }
